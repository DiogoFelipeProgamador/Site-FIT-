<?php
    ...
    $sqlq = "SELECT * FROM questionários WHERE email = '$logado' ORDER BY id DESC";
    $resultq = $conexao->query($sqlq);
...
if($result->num_rows > 0){
$user_dataq = mysqli_fetch_assoc($resultq);
$questao1 = $user_dataq['questao1'];
$questao2 = $user_dataq['questao2'];
$questao3 = $user_dataq['questao3'];
$questao4 = $user_dataq['questao4'];    
}
