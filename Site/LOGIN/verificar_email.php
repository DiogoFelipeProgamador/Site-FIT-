...
if(isset($_POST['submit'])) {
    ...
    if($result->num_rows > 0) {
        ...
        $codigo_verificacao = rand(1000, 9999); // Pode ser um número aleatório de 4 dígitos
        ...
        $headers = 'From: fitplus@pascoalonveiculos.com'; // Substitua com o seu endereço de e-mail
