...
<body>
    ...
    <section class="cauculo-fc-ideal">
        <div class="box-cauculo-fc">
            <h1 id="titulo-fc-ideal">CALCULAR A FC IDEAL</h1>
            <h1>Idade</h1>
            <input type="text" id="age-fc">
            <select id="options-cauculo">
                <option value="1">Homem</option>
                <option value="2">Mulher</option>
            </select>
            <button onclick="caucularok()">Caucular</button>
            <h1 id="text_area_info"></h1>
            <h1 id="text_area_certo"></h1>
        </div>
    </section>
