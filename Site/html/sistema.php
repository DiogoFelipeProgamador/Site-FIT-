...
if ($result_check_questionnaire->num_rows > 0) {
    ...
    if ($questionario_respondido == 1) {
        ...
        header("Location: sistemacomresults.php");
        exit;
    }
}
...
<body>
    ...
    <section class="calculos-usuario">
        ...
        <div class="titulo-box">
            ...
            <input type="radio" name="questions1" id="yes" value="yes">
            <label for="questions">Sim</label>
            <input type="radio" name="questions1" id="no" value="no">
            <label for="questions">Não</label>
            </div>
            <div class="questions">
            <h1>Você pratica exercícios fisícos? </h1>
            <input type="radio" name="questions2" id="yes" value="yes">
            <label for="questions">Sim</label>
            <input type="radio" name="questions2" id="no" value="no">
            <label for="questions">Não</label>
            </div>
            <div class="questions">
            <h1>Você bebe muita água? </h1>
            <input type="radio" name="questions3" id="yes" value="yes">
            <label for="questions">Sim</label>
            <input type="radio" name="questions3" id="no" value="no">
            <label for="questions">Não</label>
            </div>
            <div class="questions">
            <h1>Você utiliza muita açucar e sal para fazer comida? </h1>
            <input type="radio" name="questions4" id="yes" value="yes">
            <label for="questions">Sim</label>
            <input type="radio" name="questions4" id="no" value="no">
            <label for="questions">Não</label>
            </div>
